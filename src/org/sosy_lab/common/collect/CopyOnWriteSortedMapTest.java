...
public class CopyOnWriteSortedMapTest {
   ...
   * for mutability.
   */
  private static class ImmutableViewSortedMapTestSuiteBuilder<K, V>
  ...
  public static junit.framework.Test suite() throws NoSuchMethodException, SecurityException {
    // Our collection views are immutable, so we need special TestSuiteBuilder
    return new ImmutableViewSortedMapTestSuiteBuilder<String, String>()
